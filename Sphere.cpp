...
Sphere::Sphere() 
    : centre(0,0,0), radius(0), radius2(0), color(0,0,0) 
{
}

Sphere::Sphere(Vector3f centre, float radius, Vector3f color) 
    : centre(centre), radius(radius), radius2(radius*radius), color(color)
{
}

bool Sphere::doesIntersect(float& t, Vector3f rayOrigin, Vector3f rayDirection) {
